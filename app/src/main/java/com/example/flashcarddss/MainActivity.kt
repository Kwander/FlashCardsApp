...
import com.example.flashcarddss.AddCardActivity
import com.example.flashcarddss.Flashcard
import com.example.flashcarddss.FlashcardDatabase
import com.example.flashcarddss.R
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val resultLauncher = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            ...
            if (extras != null) { //modified by week 5 lab
                val question = data.getStringExtra("QUESTIONKEY")
                val answer = data.getStringExtra("ANSWERKEY")
